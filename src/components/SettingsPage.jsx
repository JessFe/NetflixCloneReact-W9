              ...
              <div className="row mt-3 mb-3">
                <div className="col-12 col-md-3 col-lg-4 col-xxl-3">
                  <div className="d-flex d-md-inline-block justify-content-between mb-2 mb-md-0">
                    <h5 className="text-gray text-uppercase text-nowrap fs-6 fw-normal">Membership &amp; Billing</h5>
                    ...
                    <a className="d-inline-block d-sm-none page-link link-danger text-end fs-6" href="#">
                      X cancel
                    </a>
                  </div>
                </div>
                ...
                <div className="col-12 col-md-9 col-lg-8 col-xxl-9">
                  <div className="row">
                    <div className="col-12 col-sm">
                      <div>
                        <img className="pe-2" src="./assets/avatar.png" alt="avatar" width="30" />
